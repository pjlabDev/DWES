	...
	<div class="container">
		...
		<form action="CineController" method="POST">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="director" placeholder="Nombre director">
				<label>Titulo pelicula</label>
				<input class="form-control" type="text" name="titulo" placeholder="Titulo pelicula">
				<label>Fecha de alta</label>
				<input class="form-control" type="text" name="fecha" placeholder="YYYY-MM-DD">
				<small class="form-text text-muted">Formato de fecha YYYY-MM-DD</small>
				<br>
				<input class="btn btn-success" type="submit" name="action" value="Anadir pelicula">
