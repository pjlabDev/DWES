...
<body>
	...
	<a href="consultaDirector.jsp"><button type="button" class="btn btn-warning">Volver</button></a>
	
	<a href="index.jsp"><button type="button" class="btn btn-warning">Inicio</button></a>
